...
| 技能 | `skills/` | `skills/` | 包含 codex、model-switch、sleep-mode、python-testing、windows-development-environment、screenlingua、agent-workflow-fortress；其中 sleep-mode 通过项目 `.hermes/sleep-mode/` 状态账本和 Hermes cron 管理持久队列，不复制运行时或凭据 |
